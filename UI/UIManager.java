    ...
    public static void UpdateGameInfo()
    {
        ...
        if(Data.PlayerSoldierLabels.size() != 0)
        {
            ...
            for(int i = 0; i < players.size(); i++)
            {
                ...
                playerUnEmSoldier.setText(String.valueOf((TurnManager.HasFirstRunSodlier ? SelectedPlayer.getFirstRunUnimployedSoldiersCount() : SelectedPlayer.getUnimployedSoldiersCount())));
